...
function elodin_jobs_register_content_type() {

	//* NAME
	$name_plural = 'Job listings';
	$name_singular = 'Job listing';
	$post_type = 'jobs';
	$slug = 'jobs';
	$icon = 'businessperson'; //* https://developer.wordpress.org/resource/dashicons/
...
add_action( 'init', 'elodin_jobs_register_content_type' );